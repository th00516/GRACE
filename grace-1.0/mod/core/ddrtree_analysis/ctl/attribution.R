core.ddrtree_analysis.ctl.attr_chooser <- function(id, label, choices, selected, disp) {
...
core.ddrtree_analysis.ctl.attr_picker <- function(id, label, choices, selected, disp) {
