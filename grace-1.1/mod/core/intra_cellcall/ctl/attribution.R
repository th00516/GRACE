core.intra_cellcall.ctl.attr_chooser <- function(id, label, choices, selected, disp) {
...
core.intra_cellcall.ctl.attr_input <- function(id, label, value, disp) {
...
core.intra_cellcall.ctl.attr_picker <- function(id, label, type, disp) {
