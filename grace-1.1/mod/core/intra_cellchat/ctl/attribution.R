core.intra_cellchat.ctl.attr_chooser <- function(id, label, choices, selected, disp) {
...
core.intra_cellchat.ctl.attr_picker <- function(id, label, type, disp) {
...
core.intra_cellchat.ctl.attr_picker.mutable <- function(id, label, choices, disp) {
