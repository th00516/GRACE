core.manual_annotation.ctl.attr_chooser <- function(id, label, choices, selected, disp) {
...
core.manual_annotation.ctl.attr_picker <- function(id, label, choices, selected, disp) {
