...
core.inter_communication.UI <- sidebarLayout(
  sidebarPanel(
    uiOutput('inter_communication_ctl_exec_attr_1'),
    uiOutput('inter_communication_ctl_exec_attr_2'),
    uiOutput('inter_communication_ctl_exec_1'),
    
    hr(),
    
    uiOutput('inter_communication_ctl_1'),
    uiOutput('inter_communication_ctl_2'),
