...
core.intra_communication.UI <- sidebarLayout(
  sidebarPanel(
    uiOutput('intra_communication_ctl_exec_attr_1'),
    uiOutput('intra_communication_ctl_exec_attr_2'),
    uiOutput('intra_communication_ctl_exec_1'),
    
    hr(),
    
    uiOutput('intra_communication_ctl_1'),
    uiOutput('intra_communication_ctl_2'),
