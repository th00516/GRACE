core.ref_based_annotation.ctl.attr_chooser <- function(id, label, choices, selected, disp) {
...
core.ref_based_annotation.ctl.attr_picker <- function(id, label, choices, selected, disp) {
